...
Pages.Verify = (() => {
  ...
  function _renderResults(onlyMismatch = false) {
    ...
    const rows = list.map((r,i) => {
      ...
      return `
        <tr style="border-bottom:1px solid var(--bd);${rowBg}">
          <td style="padding:9px 13px;font-size:12px;color:var(--tx3);text-align:center">${i+1}</td>
    ...
    el.innerHTML = `
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:var(--bd);border-radius:var(--r);overflow:hidden;margin-bottom:12px">
        <div style="background:var(--bg);padding:10px 14px;text-align:center">
          <div style="font-size:12px;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;margin-bottom:3px">총 비교</div>
      ...
      <div style="background:var(--card);border:1px solid var(--bd);border-radius:var(--r);overflow:auto;margin-bottom:10px">
        <table style="width:100%;border-collapse:collapse;font-size:12px">
          <thead><tr style="background:var(--bg)">
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd);width:32px;text-align:center">#</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd)">날짜</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd)">LOT/번호</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd)">지역</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd);text-align:right">리포트 ${typeLabel}</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd);text-align:right">DB ${typeLabel}</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd);text-align:right">차이</th>
            <th style="padding:9px 13px;font-size:12px;font-weight:500;color:var(--tx3);text-transform:uppercase;letter-spacing:.05em;border-bottom:1px solid var(--bd)">결과</th>
          </tr></thead>
    ...
    el.innerHTML = `
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:14px">
        <div style="background:var(--card);border:1px solid var(--bd);border-radius:var(--r);padding:14px">
          <div style="font-size:12px;font-weight:500;text-transform:uppercase;letter-spacing:.06em;color:var(--tx3);margin-bottom:8px;display:flex;align-items:center;gap:6px">
          ...
          <div style="font-size:12px;font-weight:500;text-transform:uppercase;letter-spacing:.06em;color:var(--tx3);margin-bottom:6px;display:flex;align-items:center;gap:6px">
          ...
          <textarea id="vfy-paste" style="width:100%;height:120px;padding:10px 13px;border:0.5px solid var(--bd2);border-radius:var(--rs);font-size:12px;font-family:var(--font-mono);background:var(--bg);color:var(--tx);resize:vertical;line-height:1.5"
